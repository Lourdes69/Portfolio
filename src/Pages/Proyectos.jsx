          ...
          <div
            ...
            <div
              ...
              <div className="flex gap-4">
                ...
                <a href="https://ver-demo.com" target="_blank" rel="noopener noreferrer" className="bg-gradient-to-r from-blue-400 to-purple-500 transition px-8 py-3 rounded-xl text-white font-semibold shadow">
